        ...
        async processNewWord(evt) {
            ...
            if respnse.data.result === "not-word" {
                ...
                if (wordScore == 0) {
                    ...
                    ${'.game-score'}.text(this.gameScore)
...
// Tor's first aborted attempt at writing this from scratch
// $wordInput = $('#word')
// $wordSubmitForm = $('#word-submit-form')

// $wordSubmitForm.on('submit', submitWord)
// function submitWord(evt) {
//     evt.preventDefault();
//     console.debug('new word event:', evt);
// }